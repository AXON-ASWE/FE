...
export default function SymptomsPage() {
  ...
  const [symptoms, setSymptoms] = useState<Symptom[]>([
    {
      id: 1,
      name: 'Đau đầu',
      description: 'Đau đầu kéo dài, chóng mặt',
      departments: ['Thần kinh', 'Nội tổng hợp'],
    },
    {
      id: 2,
      name: 'Đau bụng',
      description: 'Đau vùng bụng, buồn nôn',
      departments: ['Tiêu hóa'],
    },
  ]);
  ...
  const handleSave = () => {
    ...
    if (editing.id === 0) {
      setSymptoms((prev) => [...prev, { ...editing, id: Date.now() }]);
      toast({
        title: 'Thành công',
